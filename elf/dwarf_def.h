...
typedef struct    dwarf_debug_s               dwarf_debug_t;
...
dwarf_debug_t*               dwarf_debug_alloc();
void                             dwarf_debug_free  (dwarf_debug_t* debug);
int                              dwarf_debug_encode(dwarf_debug_t* debug);
...
int dwarf_line_encode(dwarf_debug_t* debug, dwarf_line_machine_t* lm, vector_t* line_results, string_t* debug_line);
...
int dwarf_info_encode(dwarf_debug_t* debug, dwarf_info_header_t* header);
